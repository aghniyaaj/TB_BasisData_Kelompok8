...
<div class="container">
    ...
    <form action="proses_pesanan.php" method="POST" enctype="multipart/form-data">
        ...
        <div style="margin-top: 30px; text-align: center;">
            <p style="font-size: 18px; font-weight: bold; color: #e91e63;">
                Tolong lakukan pembayaran melalui QRIS berikut:
            </p>
            <img src="qris.png" alt="QRIS" style="max-width: 250px; margin-bottom: 20px; border-radius: 8px;"><br>

            <label for="bukti_transfer" style="font-weight: bold;">Upload Bukti Transfer (PNG/JPG):</label>
